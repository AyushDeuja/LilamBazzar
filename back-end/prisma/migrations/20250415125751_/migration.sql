-- CreateEnum
CREATE TYPE "roleType" AS ENUM ('admin', 'vendor', 'customer');
...
CREATE TABLE "roles" (
    "id" SERIAL NOT NULL,
    "role_name" "roleType" NOT NULL DEFAULT 'customer',
...
-- CreateIndex
CREATE UNIQUE INDEX "organizations_pan_no_key" ON "organizations"("pan_no");
